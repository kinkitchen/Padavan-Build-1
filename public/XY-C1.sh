...
sed -i "s/192.168.2/$lan_ip/g" $default_path/defaults.h
 ...
 sed -i 's/{ "wan_pppoe_username", "" }/{ "wan_pppoe_username", "13751663678@139.gd" }/g' $default_path/defaults.c
 sed -i 's/{ "wan_pppoe_passwd", "" }/{ "wan_pppoe_passwd", "201809" }/g' $default_path/defaults.c
